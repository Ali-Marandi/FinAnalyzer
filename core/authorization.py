...
PERMISSION_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "ledger.period.close.request": {"description": "Request a controlled fiscal-period close", "sensitive": True},
    "ledger.period.close.approve": {"description": "Approve or reject a fiscal-period close requested by another user", "sensitive": True},
